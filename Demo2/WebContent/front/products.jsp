					...
					<div class="product-one">
						...
						<div class="col-md-4 product-left p-left">
							<div class="product-main simpleCart_shelfItem">
								...
								<a href="${ctx}/front/productsDetail.jsp?id=${watch.id}&&name=${watch.name}" class="mask"><img class="img-responsive zoom-img" src="${watch.listimg}" alt="" /></a>
								<div class="product-bottom">
								
									<h3><a href="${ctx}/front/productsDetail.jsp">${watch.name}</a></h3>    
									<p>Explore Now</p>
