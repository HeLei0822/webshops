...
<body> 
  ...
  <table border="1px">
		<th>User</th><th>Watch </th><th>count</th><th>unitPrice</th><th>Check<br><input type="submit" value="Delete" name="Delete"/></th><th>Buy Now</th><th>Delete</th></tr>
	<c:forEach items="${map}" var="map">
		...
		<td><%=session.getAttribute("user") %></td>
			...
			<td width="60px"><input type="checkbox" name="delete" value="${map.value.id}"/></td>
			<td><a href="${ctx}/watch/order?id=${map.value.id}&count=${map.value.count}">Buy</a></td>
			<td><a href="${ctx}/watch/deleteWatch?id=${map.value.id}">Delete</td>
		</tr> 
		</c:forEach>
	</table>
	<div class="ds">
